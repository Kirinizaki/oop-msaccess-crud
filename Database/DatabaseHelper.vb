...
Public Class DatabaseHelper
    ...
    Private Shared ReadOnly dbPath As String = Path.Combine(Application.StartupPath, "..\..\..\data\registration.accdb")
    Private Shared ReadOnly connectionString As String = $"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={dbPath};"

    '--- Get all records ---
    Public Shared Function GetAllRecords() As List(Of Registration)
